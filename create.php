...
<body>
    <div class="container">
        <header>
            ...
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="create.php"><i class="fas fa-user-plus"></i> Tambah Mahasiswa</a></li>
                </ul>
            </nav>
        </header>
        ...
        <main>
            <div class="card">
                <h2><i class="fas fa-user-edit"></i> Tambah Data Mahasiswa</h2>
                
                <form action="process.php?action=create" method="POST">
                    <div class="form-group">
                        <label for="npm"><i class="fas fa-id-card"></i> NPM</label>
                        <input type="text" id="npm" name="npm" required placeholder="Masukkan NPM mahasiswa">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="program_studi" name="program_studi" required>
                            ...
                            <option value="MI">Pendidikan Informatika</option>
                        </select>
                    </div>
